...
var (
	appConfigDir    = folderutil.AppConfigDirOrDefault(".config", "vulnsight")
	defaultCertFile = filepath.Join(appConfigDir, "keys", "vulnsight-user.crt")
	defaultPrivKey  = filepath.Join(appConfigDir, "keys", "vulnsight-user-private-key.pem")
)
