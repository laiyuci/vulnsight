...
import (
	...
	generator "github.com/projectdiscovery/vulnsight/v3/pkg/js/devtools/bindgen"
...
func process() error {
	...
	for _, module := range modules {
		...
		data, err := generator.CreateTemplateData(filepath.Join(dir, module), "github.com/projectdiscovery/vulnsight/v3/pkg/js/libs/")
		if err != nil {
